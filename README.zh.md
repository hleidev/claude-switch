...
claude-switch setup   # 把 `cs` shell function 写入你的 rc 文件
exec $SHELL
```
...
| `Formula/` | [hleidev/homebrew-claude-switch](https://github.com/hleidev/homebrew-claude-switch) tap 的 Homebrew 公式 |
